...
export type TransientVisualSignal = 'softFail' | 'terminalFail' | 'firstToken';
...
export const VALID_TRANSIENT_SIGNALS: readonly TransientVisualSignal[] = ['softFail', 'terminalFail', 'firstToken'];
