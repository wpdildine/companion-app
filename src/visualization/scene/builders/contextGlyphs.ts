...
> {
  ...
  return {
    ...
    opacityScaleBack: a.opacityScaleBack,
    opacityScaleFront: a.opacityScaleFront,
    scaleBack: a.scaleBack,
    scaleFront: a.scaleFront,
    motionGainBack: a.motionGainBack,
    motionGainFront: a.motionGainFront,
    relaxSpeed: a.relaxSpeed,
